...
/**
 * User interface which take care of manage the packages
 *
 */
public class ManagePackageUI extends JFrame {
  ...
  /**
   * Method for building the various panels within the ManagePackageUI frame as
   ...
   * 
   * @param activityList takes parameter of type List
   * @param table takes parameter of type JTable
   */
   ...
   * 
   * @param selectedActivityList stands for parameter of type List
   */
   ...
   * Method which allows you to set up table
   * 
   * @param activityList stands for parameter of type List
   */
